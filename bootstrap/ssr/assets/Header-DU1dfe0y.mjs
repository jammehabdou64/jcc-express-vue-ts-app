...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(_attrs)}><header class="w-full h-16 border-b bg-white"><div class="container mx-auto flex h-full items-center">`,
      );
      _push(
        ssrRenderComponent(
          unref(Link),
      ...
      _push(
        `<nav class="ml-auto flex gap-4 sm:gap-6"><a class="text-sm font-medium hover:underline underline-offset-4" href="https://www.jcc-express.uk" target="_blank">Docs</a>`,
      );
      _push(
        ssrRenderComponent(
          unref(Link),
          ...
          },
          {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                return [createTextVNode("Register")];
              }
            }),
            _: 1,
          },
